...
namespace TriangleNet.Voronoi.Legacy
{
    ...
    public class SimpleVoronoi : IVoronoi
    {
        ...
        private void Generate()
        {
            ...
            this.points = new Point[_TriangleNetMesh.triangles.Count + _TriangleNetMesh.hullsize];
            this.regions = new Dictionary<int, VoronoiRegion>(_TriangleNetMesh.vertices.Count);
