...
namespace TriangleNet.Voronoi.Legacy
{
    ...
    public class BoundedVoronoiLegacy : IVoronoi
    {
        ...
        private void Generate()
        {
            ...
            this.regions = new List<VoronoiRegion>(_TriangleNetMesh.vertices.Count);

            this.points = new Point[_TriangleNetMesh.triangles.Count];
            this.segPoints = new List<Point>(_TriangleNetMesh.subsegs.Count * 4);
